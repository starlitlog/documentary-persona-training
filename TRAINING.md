...
We will train and evaluate seven models to compare performance:
...
| **Llama 3 8B Instruct** | Instruct | `meta-llama/Meta-Llama-3-8B-Instruct` | Same architecture as base - fair comparison of instruct vs base |
| **Mistral 7B** | Base | `mistralai/Mistral-7B-v0.3` | Efficient architecture, good at pattern learning |
| **Mistral 7B Instruct** | Instruct | `mistralai/Mistral-7B-Instruct-v0.3` | Same architecture as base - fair comparison of instruct vs base |
| **Qwen2.5 14B** | Base | `Qwen/Qwen2.5-14B` | Scale test at 14B |
| **Qwen2.5 14B Instruct** | Instruct | `Qwen/Qwen2.5-14B-Instruct` | Scale test at 14B - base vs instruct comparison |
| **Gemma 2 27B** | Base | `google/gemma-2-27b` | Large model test - requires QLoRA (4-bit) to fit in 48GB VRAM |

**Hardware**: RTX 8000 (48GB VRAM) - sufficient for all models with LoRA/QLoRA fine-tuning.
